...
public class GetAllOptionGroupOfShopHandler : IQueryHandler<GetAllShopOptionGroupQuery, Result>
{
    ...
    {
        var data = _optionGroupRepository.GetAllShopOptonGroup(_currentPrincipalService.CurrentPrincipalId, request.Title, request.Status, request.PageIndex, request.PageSize);
