...
public class GetAllOwnDeliveryPackageForWebValidator : AbstractValidator<GetAllOwnDeliveryPackageForWebQuery>
{
    public GetAllOwnDeliveryPackageForWebValidator()
    {
        RuleFor(x => x.Status)
            .NotEmpty()
