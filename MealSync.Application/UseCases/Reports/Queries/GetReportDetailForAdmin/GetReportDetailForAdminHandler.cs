...
public class GetReportDetailForAdminHandler : IQueryHandler<GetReportDetailForAdminQuery, Result>
{
    ...
    public GetReportDetailForAdminHandler(
    ...
    public async Task<Result<Result>> Handle(GetReportDetailForAdminQuery request, CancellationToken cancellationToken)
    {
