...
namespace MealSync.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20240926031212_FixShop_OperatingDay")]
    partial class FixShop_OperatingDay
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("MealSync.Domain.Entities.OperatingDay", b =>
                {
                    ...
                    b.HasIndex("ShopOwnerId")
                        .HasDatabaseName("ix_operating_day_shop_owner_id");
            ...
            modelBuilder.Entity("MealSync.Domain.Entities.ShopOwner", b =>
                {
                    ...
                    b.Property<int>("AverageTotalOrderHandleInDay")
                        .HasColumnType("int")
                        .HasColumnName("average_total_order_handle_in_day");
