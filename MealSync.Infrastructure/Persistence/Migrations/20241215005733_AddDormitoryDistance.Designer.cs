...
namespace MealSync.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20241215005733_AddDormitoryDistance")]
    partial class AddDormitoryDistance
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MealSync.Domain.Entities.DormitoryDistance", b =>
                {
                    b.Property<long>("DormitoryFromId")
                        .HasColumnType("bigint")
                        .HasColumnName("dormitory_from_id");

                    b.Property<long>("DormitoryToId")
                        .HasColumnType("bigint")
                        .HasColumnName("dormitory_to_id");
                    ...
                    b.HasKey("DormitoryFromId", "DormitoryToId")
                        .HasName("pk_dormitory_distance");

                    b.HasIndex("DormitoryToId")
                        .HasDatabaseName("ix_dormitory_distance_dormitory_to_id");

                    b.ToTable("dormitory_distance", (string)null);
                });
            ...
            modelBuilder.Entity("MealSync.Domain.Entities.Order", b =>
                {
                    ...
                    b.Property<string>("HistoryAssignJson")
                        .HasColumnType("longtext")
                        .HasColumnName("history_assign_json");
            ...
            modelBuilder.Entity("MealSync.Domain.Entities.DormitoryDistance", b =>
                {
                    b.HasOne("MealSync.Domain.Entities.Dormitory", "DormitoryFrom")
                        .WithMany("DormitoryDistanceFroms")
                        .HasForeignKey("DormitoryFromId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("FK_DormitoryDistance_DormitoryFrom");

                    b.HasOne("MealSync.Domain.Entities.Dormitory", "DormitoryTo")
                        .WithMany("DormitoryDistanceTos")
                        .HasForeignKey("DormitoryToId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("FK_DormitoryDistance_DormitoryTo");

                    b.Navigation("DormitoryFrom");

                    b.Navigation("DormitoryTo");
                });
            ...
            modelBuilder.Entity("MealSync.Domain.Entities.Dormitory", b =>
                {
                    ...
                    b.Navigation("DormitoryDistanceFroms");

                    b.Navigation("DormitoryDistanceTos");
